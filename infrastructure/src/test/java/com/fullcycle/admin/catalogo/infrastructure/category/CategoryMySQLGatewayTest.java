...
class CategoryMySQLGatewayTest {
    ...
    void givenAValidCategory_whenCallsUpdate_shouldReturnCategoryUpdated() {
        ...
        final var actualCategory = categoryGateway.create(aUpdatedCategory);
    ...
    @Test
    void givenAPrePersistCategoryAndValidCategoryId_whenTryToDeleteIt_shouldDeleteCategory() {
    ...
    @Test
    void givenAPrePersistCategoryAndValidCategoryId_whenCallsFindById_shouldReturnCategory() {
        final var expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;
    ...
    @Test
    void givenPrePersistCategories_whenCallsFindAll_shouldReturnPaginated() {
    ...
    @Test
    void givenPrePersistCategoriesAndDocAsTerms_whenCallsFindAllAndTermsMatchsCategoryName_shouldReturnPaginated() {
        final var expectedPage = 0;
        final var expectedPerPage = 1;
    ...
    @Test
    void givenPrePersistCategoriesAndMaisAssistidaAsTerms_whenCallsFindAllAndTermsMatchsCategoryDescription_shouldReturnPaginated() {
        final var expectedPage = 0;
        final var expectedPerPage = 1;
        final var expectedTotal = 1;
